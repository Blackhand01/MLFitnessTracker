...
# Boxplot grouped by label (acc x,y,z e gyr x,y,z)
...
# Sto mischiando tutti i tipi di esercizi! 
# quindi risultano molti dati da buttar via perchè pare pieno di outliers
...
df[outlier_columns[3:] + ["label"]].plot.hist(by="label", figsize=(20, 20), layout=(3, 3))
# Most of the data follows the bell shaped distribution
